	...
	<section class="section section-search search-medicine">
		<div class="container-fluid">
			<div style="position: absolute;top: 0;left: 50px">
				<img src="<?= base_url() ?>assets/img/medicine/dis9.png" class="img-fluid" style="height: 183px;" alt="">
			</div>
			...
			<div style="position: absolute;top: 0;right: 50px">
				<img src="<?= base_url() ?>assets/img/medicine/dis5.png" class="img-fluid" style="width: 290px;height: 183px" alt="">
			</div>
		</div>
	</section>
	<!-- /Home Banner -->
...
<script>
	...
	{
		$.ajax({
			url:"disease/diseasePages/" + page + '/' + searchStr,
			method:"GET",
			dataType:"json",
			success:function(data)
			{
				$('#medicine').html(data.disease);
