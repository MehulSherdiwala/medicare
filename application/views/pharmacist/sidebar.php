			...
			<div class="dropdown item">
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-w-180">
					<ul class="list">
						...
						<li><a class="align-items-center" href="<?= base_url() ?>pharmacist/wallet">
								<span class="icon icofont-wallet"></span> Wallet</a></li>
						<li><a class="align-items-center" href="<?= base_url() ?>pharmacist/pharmacist-profile-setting">
		...
		<div class="main-menu">
			<nav class="main-menu-wrap">
				<ul class="menu-ul">
					...
					<li class="menu-item"><a class="item-link" href="<?= base_url() ?>pharmacist"><span
								class="link-icon icofont-thermometer-alt"></span> <span
								class="link-text">Dashboard</span></a></li>
					<li class="menu-item">
						<a class="item-link" href="<?= base_url() ?>pharmacist/medicine">
							<span class="link-icon icofont-medicine"></span>
							<span class="link-text">Medicines</span>
						</a>
					</li>
					<li class="menu-item">
						<a class="item-link" href="<?= base_url() ?>pharmacist/patient">
					...
					if	($dpt == 4 || $dpt == 0)
					{
						...
						<li class="menu-item">
							<a class="item-link" href="<?= base_url() ?>pharmacist/sales">
					...
					} else
					{
						?>
						<li class="menu-item">
							<a class="item-link" href="<?= base_url() ?>pharmacist/pharmacy">
								<span class="link-icon icofont-envelope"></span>
								<span class="link-text">Offline Selling</span>
							</a>
						</li>
						<?php
					}
		...
		<div class="navbar-skeleton vertical">
			<div class="top-part">
				...
				<div class="sk-menu">
					...
					<span class="sk-menu-item bg animated-bg w-75"></span> <span
