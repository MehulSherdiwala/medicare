							...
							<div class="table-responsive" id="data">
								<table class="table" id="dataTable">
									<thead>
										<tr>
											<th>Patient Name</th>
											<th>Patient <?= (($_SESSION['dptId'] == 3)? 'Phone No' : 'Email') ?></th>
											<th>First Order Id</th>
				...
				<div class="row h-100 align-items-center">
					<div class="col-12 col-md-6 d-none d-md-block">
						<ul class="page-breadcrumbs">
							...
							<li class="item"><a class="link" href="javascript:void(0)">Patients</a> <i
									class="separator icofont-thin-right"></i></li>
						</ul>
					</div>
				</div>
...
<div aria-hidden="true" class="modal fade" id="report" role="dialog" tabindex="-1">
	<div class="modal-dialog  modal-lg modal-dialog-scrollable">
		<div class="modal-content">
			...
			<form action="<?= base_url()?>pharmacist/report/patient" method="post" target="_blank">
