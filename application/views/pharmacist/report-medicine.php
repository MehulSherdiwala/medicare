...
$pdf->Cell(190, 8, 'Medicine Report', 0, 0, 'C');
$pdf->SetXY(12, 30);
$pdf->SetFont('helvetica', '', 10, '', true);
/*
 * b74c4c
...
$htmlData = '
			...
			<table width="100%" style="padding:10px;border: 1px solid #7c9bbd;">
				<tr style="background-color: #7c9bbd;">
					<th width="11%">Medicine Id</th>
					<th>Medicine Name</th>
					<th width="14%">Medicine Description</th>
					<th width="11%">Price</th>
					<th>Dose</th>
					<th width="15%">Capacity</th>
					<th>Disease Name</th>
					<th style="border-right: 1px solid #7c9bbd;">Date</th>
				</tr>
			';
