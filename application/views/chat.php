			...
			<div class="row">
				<div class="col-xl-12">
					<div class="chat-window">
						<div hidden id="spinner"></div>
						<!-- Chat Right -->
						<div class="chat-cont-right offset-2" style="box-shadow: 0px 6px 20px rgba(0, 0, 0, 0.53)">
								...
								<div class="media">
									<div class="media-img-wrap">
										<div class="avatar avatar-online">
											<img src="<?= base_url()?>assets/img/doctors/doctor-thumb-02.jpg" alt="User Image" class="avatar-img rounded-circle" id="profile">
										</div>
									</div>
...
<script>
	...
	let appId = hashes.substring(index+1);
	async function checkApp(){
		const res  = await fetch('<?= base_url()?>chat/checkApp/' + appId);
