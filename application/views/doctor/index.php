							...
							<div class="card animated fadeInUp delay-01s bg-light">
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-8"><h6 class="mt-0 mb-1">Total Appointments</h6>
											<div class="count text-primary fs-20"><?= $data['totalApp']?></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card animated fadeInUp delay-03s bg-light">
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-8 pr-0"><h6 class="mt-0 mb-1">Today's Appointment</h6>
											<div class="count text-primary fs-20"><?= $data['today']?></div>
										</div>
									</div>
								</div>
							</div>
				...
				axisPointer: {
					label: {
						formatter: function (params) {
							return 'Appointments ' + params.value + (params.seriesData.length ? '：' + params.seriesData[0].data : '');
						}
					}
				},
				data: ['<?= $data['appDate']?>']
