...
$pdf->SetTitle('Commission Report');
...
$pdf->Cell(190, 8, 'Commission Report', 0, 0, 'C');
$pdf->SetXY(12, 26);
$pdf->SetFont('helvetica', '', 11.5, '', true);
$pdf->Cell(10, 8, 'User Type : '.$data['type'], 0, 0, 'L');
$pdf->SetXY(12, 32);
$pdf->Cell(10, 8, 'User Name : '.$data['username'], 0, 0, 'L');
$pdf->SetXY(12, 39);
$pdf->SetFont('helvetica', '', 10, '', true);
/*
 * b74c4c
...
$htmlData = '
			...
			<table width="100%" style="padding:10px;border: 1px solid #7c9bbd;">
				<tr style="background-color: #7c9bbd;">
					<th>Commission Id</th>
					<th>Date</th>
					<th style="border-right: 1px solid #7c9bbd;">Amount</th>
				</tr>
			';
