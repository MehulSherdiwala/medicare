<?php
$age='';
foreach ($data['patientAge'] as $k => $datum)
{
	$age .= '{ value:'. $datum.', name: "'.$k.'"},';
}
?>
<!doctype html>
<html lang="en">
<head>
	...
	<link rel="stylesheet" href="<?= base_url() ?>assets/plugins/fontawesome/css/all.min.css"><!-- Theme CSS -->
                ...
                <div class="page-content">
                            ...
                            <div class="card animated fadeInUp delay-01s bg-light">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-7"><h6 class="mt-0 mb-1">Patients</h6>
                            ...
                            <div class="card animated fadeInUp delay-02s bg-light">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-7"><h6 class="mt-0 mb-1">Doctors</h6>
                                            <div class="count text-primary fs-20"><?= $data['doc']?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col col-12 col-md-6 col-xl-3">
                            <div class="card animated fadeInUp delay-03s bg-light">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col col-5">
                                            <div class="icon p-0 fs-48 text-primary opacity-50 icofont-user-alt-2"></div>
                                        </div>
                                        <div class="col col-7"><h6 class="mt-0 mb-1">Pharmacist</h6>
                                            <div class="count text-primary fs-20"><?= $data['phar']?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col col-12 col-md-8">
                            <div class="card">
                                <div class="card-body"><h4 class="mt-0 mb-1">Doctor Joining Survey</h4>
                                    <div class="chat-container" style="margin-top: 50px;" id="newDoctor"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col col-12 col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="chat-container container-h-300" id="patineAge"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
	...
	var options = {
		...
		series: {
				...
				type: 'line',
				smooth: true,
				data: [<?= $data['patientCnt']?>]
			}
	};

	myChart.setOption(options);

	var myChart2 = echarts.init(document.getElementById('newDoctor'));
		...
		xAxis:
			{
				...
				axisPointer: {
					label: {
						formatter: function (params) {
							return 'Doctors ' + params.value + (params.seriesData.length ? '：' + params.seriesData[0].data : '');
						}
					}
				},
				data: ['<?= $data['docDate']?>']
	...
	var age = echarts.init(document.getElementById('patineAge'));
	...
	age.setOption(optionsAge);
	// Resize chart
	$(function() {
		$(window).on('resize', resize);

		function resize() {
			setTimeout(function() { myChart2.resize();age.resize();myChart.resize() }, 200);
		}
	})
</script>
</body>
